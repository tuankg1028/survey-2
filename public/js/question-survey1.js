(function($) {
  ...
  $("body").on("click", ".next-section", function() {
    ...
    $(this)
      .next()
      .next()
      .css("display", "flex"); // next-section2
  ...
  $("body").on("click", ".next-section2", function() {
    $(this)
      .next()
      .show();
  ...
  function appTimer() {
    ...
    // show collect
    setTimeout(() => {
      $(".slick-active .next-section").hide();
    ...
    // show comment
    setTimeout(() => {
      $(".slick-active .next-section2").hide();
